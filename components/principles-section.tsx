  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "VOICE ", highlight: false },
        { text: "FIRST", highlight: true },
      ],
      description: "Natural voice interaction as the primary interface. Real-time translation breaking language barriers.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        { text: "OFFLINE ", highlight: true },
        { text: "CAPABLE", highlight: false },
      ],
      description: "Independent AI processing without cloud dependency. Privacy-focused and always available.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "MODULAR ", highlight: false },
        { text: "AI", highlight: true },
      ],
      description: "Embed any AI model: GPT, Grok, Claude via API keys. Flexible and user-customizable intelligence.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "AGENT ", highlight: false },
        { text: "AUTONOMY", highlight: true },
      ],
      description: "Acts as an intelligent agent. Learns from interactions and adapts to user needs seamlessly.",
      align: "right",
    },
  ]
