...
const signals = [
  {
    date: "2025.06.10",
    title: "Voice Translation v2.0",
    note: "Real-time multilingual voice translation with enhanced accuracy and latency optimization.",
  },
  {
    date: "2025.05.28",
    title: "Offline AI Processing",
    note: "Fully autonomous AI inference without cloud dependency. Privacy-first architecture.",
  },
  {
    date: "2025.05.15",
    title: "Multi-Model Integration",
    note: "Support for GPT, Grok, Claude, and custom models via API keys for extensible AI.",
  },
  {
    date: "2025.04.30",
    title: "Agent Autonomy Framework",
    note: "Intelligent agent system that learns and adapts to user behavior patterns.",
  },
  {
    date: "2025.04.12",
    title: "Real-time Audio Processing",
    note: "Advanced audio capture and synthesis for seamless voice interaction experiences.",
  },
]
